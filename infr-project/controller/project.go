...
func (c *ProjectController) CreateProject(w http.ResponseWriter, r *http.Request) {
	handleRequest(w, r, v1.CreateProjectService, func(ctx context.Context, service *application.ProjectService, req viewmodel.CreateProjectRequest) (interface{}, error) {
		return service.CreateProject(ctx, req)
	})
}

func (c *ProjectController) GetProject(id string, w http.ResponseWriter, r *http.Request) {
	handleRequest(w, r, v1.CreateProjectService, func(ctx context.Context, service *application.ProjectService, _ struct{}) (interface{}, error) {
...
func (c *ProjectController) UpdateProject(id string, w http.ResponseWriter, r *http.Request) {
	handleRequest(w, r, v1.CreateProjectService, func(ctx context.Context, service *application.ProjectService, req viewmodel.UpdateProjectRequest) (interface{}, error) {
