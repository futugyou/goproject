module github.com/futugyou/resourcequeryservice
...
replace github.com/futugyou/domaincore v1.0.0 => ../../../domaincore

replace github.com/futugyou/domaincore/mongoimpl v1.0.0 => ../../../domaincore/mongoimpl
