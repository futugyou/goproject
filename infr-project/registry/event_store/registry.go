...
type Registry struct {
	...
	stores      map[string]func(options.Options) infrastructure.IEventStore[domain.IDomainEvent]
	storeAsyncs map[string]func(options.Options) infrastructure.IEventStoreAsync[domain.IDomainEvent]
}
...
func (s *Registry) Create() (infrastructure.IEventStore[domain.IDomainEvent], infrastructure.IEventStoreAsync[domain.IDomainEvent], error) {
	if s.Options == nil {
