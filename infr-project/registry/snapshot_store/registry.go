...
type Registry struct {
	...
	events  map[string]func(context.Context, options.Options) domain.SnapshotStore[domain.EventSourcing]
}
...
func (s *Registry) RegisterComponent(
	componentFactory func(context.Context, options.Options) domain.SnapshotStore[domain.EventSourcing],
	names ...string,
) {
...
func (s *Registry) Create(ctx context.Context) (domain.SnapshotStore[domain.EventSourcing], error) {
	if s.Options == nil {
