...
var ipAllocator = &IPAM{
	SubnetAllocatorPath: common.IpamDefaultAllocatorPath,
}
...
func (ipam *IPAM) load() error {
	...
	logrus.Infof("load ipam file from: %s", subnetConfigFile.Name())
	return nil
}
...
func (ipam *IPAM) dump() error {
	...
	logrus.Infof("dump ipam file from: %s", ipamConfigFileDir)
	return nil
}
...
func (ipam *IPAM) Release(subnet *net.IPNet, ipaddr *net.IP) error {
	...
	logrus.Infof("release index: %d", index)
