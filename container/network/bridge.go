...
func (b *BridgeNetworkDriver) Create(subnet string, name string) (*NetWork, error) {
	...
	logrus.Infof("BridgeNetworkDriver creat network subnet: %s, gateway ip: %s", ipRange.String(), ip.String())
...
func (b *BridgeNetworkDriver) initBridge(n *NetWork) error {
	...
	logrus.Infof("createBridgeInterface success")
	...
	logrus.Infof("setInterfaceIp success")

	if err := setInterfaceUp(bridgeName); err != nil {
		return err
	}
	logrus.Infof("crsetInterfaceUp success")

	if err := setupIpTables(bridgeName, n.IpRange); err != nil {
		return err
	}
	logrus.Infof("setInterfaceUp success")
	return nil
}
