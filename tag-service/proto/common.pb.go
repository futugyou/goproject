...
type Pager struct {
	...
	TotleRows int64 `protobuf:"varint,3,opt,name=totle_rows,json=totleRows,proto3" json:"totle_rows,omitempty"`
}
...
func (x *Pager) GetTotleRows() int64 {
	if x != nil {
		return x.TotleRows
	}
	return 0
...
var file_proto_common_proto_rawDesc = []byte{
	...
	0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x6f, 0x74, 0x6c, 0x65, 0x5f, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74, 0x6f, 0x74, 0x6c, 0x65, 0x52, 0x6f, 0x77, 0x73, 0x22,
