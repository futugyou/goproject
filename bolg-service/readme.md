...
4. ### lumberjack 写日志的
    ...
    ```
    <details>
    <summary>作者对log做了大量的封装，使用了很多runtime的方法来获取数据，具体还是看源码吧，我只记下这个组件最基本的用法</summary>
...
9. ### opentracing and jaeger
    ...
    <details>
    <summary>写一个tracer，opentracing.SetGlobalTracer(tracer) 这句我当时忘写了，直到做grpc那章追踪连不起来才发现这个错误</summary>
