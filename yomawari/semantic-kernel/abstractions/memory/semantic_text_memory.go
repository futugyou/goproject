...
type ISemanticTextMemory interface {
	...
	Get(ctx context.Context, collection string, key string, withEmbedding bool, kernel *abstractions.Kernel) (*MemoryRecord, error)
...
func (n *NullMemory) Get(ctx context.Context, collection string, key string, withEmbedding bool, kernel *abstractions.Kernel) (*MemoryRecord, error) {
	return nil, nil
}
