...
import (
    ...
    i52613f2089d5c2e45760a12999fdd9189a97d8912aea5f6eebb961aa543d5d98 "kiota-samples/client/posts"
...
func NewPostsClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PostsClient) {
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("https://jsonplaceholder.typicode.com")
    }
